...
gen-examples:
	cp src/data/examples/valid/PersonCollection*.yaml $(EXAMPLEDIR)
...
examples/output: src/beril_model/schema/beril_model.yaml
	mkdir -p $@
...
git-init:
	git init
git-add: .cruft.json
	git add .gitignore .github .cruft.json Makefile LICENSE *.md examples utils about.yaml mkdocs.yml poetry.lock project.Makefile pyproject.toml src/beril_model/schema/*yaml src/*/datamodel/*py src/data src/docs tests src/*/_version.py project/reports/ src/local_schemasheets/
